          ...
          {clients.map((client) => (
            <div key={client.clientId} className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{client.industry} - ID: {client.clientId}</p>
                  </div>
                </div>
              ...
              <div className="px-6 py-4 bg-gray-50 border-t border-gray-100">
                ...
                <p className="text-xs text-gray-500 mt-2">Add this to any webpage to embed the chatbot.</p>
              </div>
            </div>
          ))}
        </div>
